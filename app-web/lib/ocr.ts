...
4. expenseDetail — ดึงรายละเอียดค่าใช้จ่ายให้ครบถ้วนที่สุดเท่าที่เอกสารมี ห้ามสรุปย่อเป็นประโยคสั้นๆ เพียงประโยคเดียว ถ้าเอกสารมีหลายรายการ (เช่น มีตารางรายการ/หลายบรรทัด/หลายเลขที่อ้างอิง) ให้ลิสต์ทุกรายการแยกกัน โดยระบุชื่อรายการและจำนวนเงินของแต่ละรายการ (และเลขที่อ้างอิงถ้ามี) คั่นแต่ละรายการด้วยเครื่องหมาย " | " เช่น "ค่าธรรมเนียมใบอนุญาต เลขที่ 001 2,000.00 | ค่าธรรมเนียมใบอนุญาต เลขที่ 002 2,000.00 | ค่าธรรมเนียมใบอนุญาต เลขที่ 003 2,000.00 | ค่าธรรมเนียมใบอนุญาต เลขที่ 004 2,000.00" ถ้าเอกสารมีรายการเดียว ให้ระบุชื่อรายการนั้นให้ครบถ้วนตามที่ปรากฏบนเอกสาร (ไม่ต้องย่อ)
